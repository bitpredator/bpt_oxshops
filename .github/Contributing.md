...
Welcome to the "bpt_oxshops" project repository. Thank you for your interest in contributing to the project. Full details and guidelines on how to ensure this project is managed well are included below.
...
If you require **support** with the bpt_doorlock, please utilise the channels on our official [Discord](https://discord.gg/ksGfNvDEfq). Issues regarding the features or bugs will not be handled on Discord. Please use GitHub issues to track new features or bugs.
